...
% ---------- Preambulo ----------
\instituicao{Universidade Tecnol\'ogica Federal do Paraná} % nome da instituicao
\programa{TECNOLOGIA EM AN\'ALISE E DESENVOLVIMENTO DE SISTEMAS} % nome do programa
\area{DIRETORIA DE GRADUA\c{C}\~AO E EDUCA\c{C}\~AO PROFISSIONAL} % [Engenharia Biom\'edica] ou [Inform\'atica Industrial] ou [Telem\'atica]

\documento{PROPOSTA DE TRABALHO DE CONCLUS\~AO DE CURSO} % [Disserta\c{c}\~ao] ou [Tese]
...
\autor{ELIAS DE MORAES FERNANDES} % autor do trabalho
\cita{DE MORAES FERNANDES, ELIAS} % sobrenome (maiusculas), nome do autor do trabalho
